...
public class OctaneFuelDispenseManager extends FuelDispenser implements FuelDispenseManager
{
    public OctaneFuelDispenseManager(int dispenserNumber, String vehicleType, int availablePostions, FuelRepository fuelRepo, Queue<Customer> customerList) {
        super(dispenserNumber, vehicleType, availablePostions, fuelRepo, customerList);
    }

    public OctaneFuelDispenseManager(int dispenserNumber, String vehicleType, int availablePostions, FuelRepository fuelRepo) {
        super(dispenserNumber, vehicleType, availablePostions, fuelRepo);
    }

    public OctaneFuelDispenseManager(int dispenserNumber, String vehicleType) {
    ...
    public void addAVehicleToQueue() {
        //for the moment adding process done by main dispenser but this method kept for future updates;
        System.out.println();
    }
    ...
    public String[] dispenseFuel(Customer customer, Scanner input) {
        ...
        String message = ("Dispensing 92octane to ticket-no."+customer.getTicketNumber()+
    ...
    public synchronized void updateTotalFuelIssuedBy92OctanePerDay(String[] details) {
